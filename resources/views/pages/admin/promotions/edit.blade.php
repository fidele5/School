        ...
        <div class="col-md-8 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route("promotions.update", $promotion) }}">
                            @csrf
                            @method("patch")
                            <div class="form-body">
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $promotion->nom }}" id="first-title-floating" class="form-control champ @error('nom') is-invalid @enderror" placeholder="Nom de la filière" name="nom">
                                            @error('nom')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filiere" id="filiere" class="custom-select @error('filiere') is-invalid @enderror">
                                                @foreach ($filieres as $filiere)
                                                    <option value="{{ $filiere->id }}" @if ($promotion->filiere_id == $filiere->id)
                                                        selected
