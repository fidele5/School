...
@section('content')
            <div class="slider-container rev_slider_wrapper slider-container-full-height">
                <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'sliderLayout': 'fullscreen', 'gridwidth': [1140,960,720,540], 'gridheight': [900,900,900,600], 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,576], 'navigation' : {'arrows': { 'enable': true, 'hide_under': 767, 'style': 'slider-arrows-style-1' }, 'bullets': {'enable': true, 'hide_under': 767, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 140, 'h_offset': 0}}}">
                    <ul>
                        <li class="slide-overlay slide-overlay-level-4" data-transition="fade">
                            <img src="img/slides/multi-purpose/slide-4-1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0"
                                data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg">
                            <div class="tp-caption text-color-light font-primary font-weight-thin" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="center" data-y="center" data-voffset="['-115','-115','-115','-30']" data-fontsize="['24','24','24','24']">WELCOME TO</div>
                            <h1 class="tp-caption text-color-light font-weight-normal" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="center" data-y="center" data-voffset="['-55','-55','-55','15']" data-fontsize="['44','44','44','30']" data-lineheight="['48','48','48','35']">The easiest way to show your</h1>
                            <div class="tp-caption text-color-light font-primary font-weight-normal" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="center" data-y="center" data-voffset="['0','0','0','55']" data-fontsize="['44','44','44','30']" data-lineheight="['48','48','48','35']">portfolio and share with others</div>
                            <a class="tp-caption btn btn-rounded btn-primary font-weight-semibold" href="#start" data-hash data-hash-offset="90" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="center" data-y="center" data-voffset="['100','100','100','130']" data-whitespace="nowrap" data-fontsize="['13','13','13','13']" data-paddingtop="['13','13','13','13']" data-paddingbottom="['13','13','13','13']" data-paddingleft="['65','65','65','65']"
                                data-paddingright="['65','65','65','65']">GET STARTED</a>
                        </li>
                        <li class="slide-overlay slide-overlay-level-9" data-transition="fade">
                            <img src="img/slides/multi-purpose/slide-4-2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0"
                                data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg">
                            <div class="tp-caption text-color-light font-primary font-weight-semibold" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="left" data-hoffset="60" data-y="center" data-voffset="['-70','-70','-70','-50']" data-fontsize="['23','23','23','23']" data-lineheight="['26','26','26','26']">TOP AWARD</div>
                            <div class="tp-caption text-color-light font-primary font-weight-normal" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="left" data-hoffset="60" data-y="center" data-voffset="['-25','-25','-25','5']" data-fontsize="['55','55','55','40']" data-lineheight="['60','60','60','45']">Company of the Year</div>
                            <div class="tp-caption text-color-light font-primary font-weight-thin" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="left" data-hoffset="60" data-y="center" data-voffset="['30','30','30','45']" data-fontsize="['28','28','28','28']" data-lineheight="['32','32','32','32']">World-Class Technology</div>
                            <a class="tp-caption btn btn-rounded btn-primary font-weight-semibold" href="#ourwork" data-hash data-hash-offset="90" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-x="left" data-hoffset="['60','60','60','60']" data-y="center" data-voffset="['100','100','100','130']" data-whitespace="nowrap" data-fontsize="['13','13','13','13']" data-paddingtop="['13','13','13','13']" data-paddingbottom="['13','13','13','13']"
                                data-paddingleft="['55','55','55','55']" data-paddingright="['55','55','55','55']">VIEW OUR WORK</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="100">
                                ...
                                <h2 class="word-rotator letters type font-weight-extra-bold text-6 mb-3">
                                    ...
                                    <span class="word-rotator-words waiting">
                                        ...
                                        <b class="text-primary">{{ __("pages.discipline") }}.</b>
                                    </span>
                                </h2>
                            </div>
                            <p class="lead text-4 font-weight-light pr-md-4 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300"><em>{{ __("pages.spirituality_text") }}.</em></p>
                            <p class="text-alternative-style font-weight-normal text-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">{{ __("pages.description") }}</p>
                            <a href="about-us-1.html" class="btn btn-outline btn-rounded btn-primary btn-4 font-weight-bold mt-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">{{ __("pages.more_about_us") }}</a>
                        </div>
                        <div class="col-10 col-md-5 mx-auto ml-md-auto appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
                            <div class="particles d-flex align-items-center pr-0 pr-lg-3 pr-xl-5">
                                ...
                                <img src="img/generic/collation.jpg" class="img-fluid box-shadow-5" alt="" data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 4, 'horizontal': true, 'transition': true}" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section bg-light-5">
                <div class="container">
                    <div class="row justify-content-center text-center mb-4">
                        <div class="col-md-10 col-lg-7">
                            <div class="overflow-hidden mb-2">
                                <h2 class="font-weight-bold mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">{{ __("pages.news") }}</h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="owl-carousel owl-theme dots-style-3 nav-color-dark" data-plugin-options="{'dots': true, 'nav': false, 'margin': 20, 'responsive': {'0': {'items': 1}, '575': {'items': 1}, '767': {'items': 2}, '991': {'items': 3}, '1199': {'items': 3}}}">
                                ...
                                @else
                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                        ...
                                        <strong>Désolé mais!</strong> Aucune nouvelle pour le moment!.
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <a href="{{ route('actualite') }}" class="btn btn-outline btn-rounded btn-primary btn-4 btn-h-4 font-weight-semibold text-0">{{ __("pages.see_all") }}</a>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container container-lg-custom mt-3">
                    <div class="row justify-content-center text-center">
                        <div class="col-lg-10 col-xl-8">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-duration="700ms">
                                <h2 class="font-weight-extra-bold line-height-1 mb-3">{{ __("pages.realization") }}</h2>
                            </div>
                            <p class="lead mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">Realisations mystiques. </p>
                        </div>
                    </div>
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-4 col-lg-3 d-flex justify-content-center justify-content-md-end appear-animation" data-appear-animation="fadeInRightShorter">
                            <a href="{{ route("realisation") }}" class="btn btn-outline btn-rounded btn-4 btn-primary font-weight-bold">{{ __("pages.realization") }}</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div id="portfolioLoadMoreWrapper" class="portfolio-list sort-destination" data-sort-id="portfolio" data-ajax-url="ajax/portfolio-overlay-ajax-load-more.html" data-total-pages="3">
                                    @if (count($realisations) > 0)
                                        @foreach ($realisations as $realisation)
                                            <div class="col-md-6 col-lg-4 p-0 isotope-item {{ $realisation->categorie_realisation->designation }}">
                                        ...
                                        @endforeach
                                    @else
                                        <div class="alert alert-success alert-dismissible fade show col-6 text-center" role="alert">
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                <span class="sr-only">Close</span>
                                            </button>
                                            Aucune realisation pour le moment Dommage!
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="row text-center mb-4">
                        <div class="col">
                            <div class="overflow-hidden">
                                <span class="d-block custom-font-1 text-color-primary text-3 appear-animation" data-appear-animation="maskUp">Stay Tuned</span>
                            </div>
                            <div class="overflow-hidden mb-2">
                                <h2 class="font-weight-bold mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">{{ __("pages.events") }}</h2>
                            </div>
                        </div>
                    </div>
